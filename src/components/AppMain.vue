...
<template>
 <!-- START MAIN -->
    ...
    <main>
            ...
            <div class="jumbotron-text">
              ...
              <div>
                <button class="light-b" type="button"><a href=""><i class="fa-brands fa-youtube"></i> Visit my YouTube
                    Channel</a></button>
                <button class="dark-b" type="button"><a href="">Buy Avda Today <i
      ...
      <!-- CROSSFIT -->
      <section id="crossfit">
        <div class="crossfit-jumbotron">
          <div class="crossfit-text" id="cross-text">
            <span><i class="fa-solid fa-circle-play"></i></span>
            <h1>Crossfit workout of the day</h1>
            <h2>Novembre 15th,2019</h2>
            <a class="white-cross">View all videos <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </div>
      </section>
    </main>
